...
<div class="container-fluid bg-white py-3 px-3">
    <form method="POST" action="{{ route('evo.update', $event->id) }}" enctype="multipart/form-data">
                            ...
                            <div class="modal-dialog modal-dialog-centered modal-lg">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body text-center">
                                        <img src="{{ route('images.show', ['path' => $event->image]) }}" alt="{{ __('Full Banner') }}" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-auto">
                        <a href="#" id="manage-form" class="text-decoration-none fw-semibold">
                            {{ __('Manage Form') }} <i class="ri-arrow-right-up-line"></i>
                        </a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-4 {{ $event->form_id ? '' : 'd-none' }}" id="form-select-wrapper">
                        <select class="form-select" id="form_id" name="form_id">
                            <option disabled {{ !$event->form_id ? 'selected' : '' }}>{{ __('Please select') }}</option>
        ...
        <div class="d-flex justify-content-end mb-4">
            ...
            @endif
            <button type="submit" name="action" value="update" class="btn btn-primary me-2">{{ __('Update Event') }}</button>
