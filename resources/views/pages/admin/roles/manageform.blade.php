    ...
    <div class="row">
      <div class="col">
        ...
        <div class="mb-4 text-end">
            <a href="javascript:void(0)" onclick="deleteRole();" class="btn btn-outline-danger px-4 me-2"><span class="spinner-border spinner-border-sm me-1 d-none" role="status" aria-hidden="true"></span>{{ __('Delete') }}</a>
          <button type="submit" id="submitButton" class="btn btn-primary px-4"><span class="spinner-border spinner-border-sm me-1 d-none" role="status" aria-hidden="true"></span>{{ __('Update') }}</button>
        </div>
      </div>
    </div>
  ...
  <div class="row mb-4">
    <div class="col-md-3 mb-3">
      <div class="list-group" id="list-tab" role="tablist">
        {{-- <a class="list-group-item list-group-item-action" id="list-onBehalf-list" data-bs-toggle="list" href="#list-onBehalf" role="tab" aria-controls="onBehalf">On Behalfs</a>
