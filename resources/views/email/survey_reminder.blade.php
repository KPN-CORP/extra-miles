...
<body>
    ...
    <p>{!! __('To help us improve future events, we kindly ask you to complete the evaluation form before the deadline: :deadline.', ['deadline' => '<b>'.\Carbon\Carbon::parse($survey->end_date)->format('d M Y').'</b>']) !!}</p>
